...
| # | Scope |
|---|---|
| 9 | Migrate **`qa-test`** (`verification.py`) — simplest: no LLM call, 4 Kernel imports, no gateway construction. Proves `Agent` + `ToolInvoker` + the new injection path in isolation. **Next.** |
