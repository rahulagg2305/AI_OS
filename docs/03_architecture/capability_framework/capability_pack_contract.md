...
Authoritative, always-current status: `../../19_roadmap/feature_inventory.md` (per-module completion table — rows 13, 27, 29–34). Build history: `../../19_roadmap/history/INDEX.md`.
...
- `../../19_roadmap/feature_inventory.md` (rows 13, 27, 29–34), `../../19_roadmap/history/INDEX.md`
