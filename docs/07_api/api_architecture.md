...
**Built** (`kernel/src/ai_os_kernel/routes/`, all bearer-token authenticated): `POST /api/v1/workflows`, `GET /api/v1/workflows`, `GET /api/v1/workflows/{id}`, `GET /api/v1/workflows/{id}/steps`, `GET /api/v1/workflows/{id}/events`, `GET /api/v1/workflows/{id}/run_manifest`, `POST /api/v1/workflows/{id}/cancel`, `GET /api/v1/workflow_definitions`, `GET /api/v1/agents`, `GET /api/v1/gates/results`, `GET /api/v1/approvals`, `GET /api/v1/approvals/{id}`, `GET /api/v1/approvals/history`, `POST /api/v1/packs`, `GET /api/v1/packs`, `GET /api/v1/packs/{id}`, `POST /api/v1/packs/{id}/activate`, `POST /api/v1/packs/{id}/deactivate`, `GET /api/v1/config`, `PATCH /api/v1/config`, `GET /api/v1/config/flags`, `GET /api/v1/traceability/impact/{id}`, `GET /api/v1/traceability/coverage`, `POST /api/v1/experiments`, `GET /api/v1/experiments`, `GET /api/v1/experiments/{id}`, `POST /api/v1/experiments/{id}/run`, `GET /api/v1/experiments/{id}/comparison`, `GET /api/v1/experiments/{id}/runs`, plus the health endpoints. **Real, but outside this document's originally-documented 45** (see "Deliberate documented divergences" below): `GET /api/v1/evaluation/cost-and-quality`, `POST`/`DELETE /api/v1/security/role-grants`, `GET /api/v1/version`, `POST /api/v1/workflows/se.delivery_pipeline`.
...
- The Logs/Traces observability endpoints — no `/logs`/`/traces` route exists (no log/trace-query HTTP surface). §6.4's Agents/Gates groups are each real for one documented route (`GET /agents`, `GET /gates/results`, both 2026-08-10) — `usage/cost`, `usage/tokens`, `gates/trends`, and the "+ stats" half of `agents` remain unbuilt. **§6.3 Experiments is now fully real** (`POST /experiments`, `GET /experiments`, `GET /experiments/{id}`, `POST /experiments/{id}/run`, `GET /experiments/{id}/comparison`, `GET /experiments/{id}/runs`, 2026-08-11) — every documented §6.3 endpoint exists. **§6.6 Traceability is now real for its two query-backed routes** (`GET /traceability/impact/{id}`, `GET /traceability/coverage`, 2026-08-11) — only `GET /traceability/query` (the raw link graph) and the `logs`/`traces` routes remain. **Approvals (§6.2) and Packs/configuration (§6.5) are both fully real now — every one of their documented endpoints exists.**
