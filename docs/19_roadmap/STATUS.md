...
**Overall: 68%** (161.5 of 238 Task-equivalents complete)
...
| P02 (B) | S03 Prompt and Context Assembly | 16 | 9 | 0 | 7 | 56% |
...
| P02 (Stage B) - Minimum Viable Kernel | 95 | 78 | 83% |
...
38 Task(s) whose dependencies are all satisfied (Definition of Ready, `docs/process/ticket_templates.md`):
